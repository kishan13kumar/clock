...
def main():
    ...
    st.markdown(
        ...
        <section id="home" class="section">
            <div class="home-content">
                ...
                <div class="home-sci">
                    <a href="#"><img src="./linkedin_logo.jpg" alt="LinkedIn"></a>
                    <a href="#"><img src="./git.png" alt="GitHub"></a>
                    <a href="#"><img src="./discord 3.jpg" alt="Discord"></a>
                    <a href="#"><img src="./112-gmail_email_mail-512.webp" alt="Email"></a>
                </div>
            </div>
        </section>
        """,
    ...
    st.markdown(
        ...
        <section id="contact" class="section">
            <h2>Contact</h2>
            <div class="contact">
                <a href="https://github.com/Kishankumar1328" target="_blank"><img src="C:\Users\HP\OneDrive\Pictures\KK,HTML_files\GitHub-Mark-ea2971cee799.png" alt="GitHub"></a>
                <a href="https://www.linkedin.com/in/kishan-kumar-037175259/" target="_blank"><img src="C:\Users\HP\OneDrive\Pictures\KK,HTML_files\linkedin_logo.jpg" alt="LinkedIn"></a>
                <a href="mailto:krss132005@gmail.com" target="_blank"><img src="./112-gmail_email_mail-512.webp" alt="Email"></a>
                <a href="https://discord.com/invite/tenacious_quail_34080" target="_blank"><img src="./discord 3.jpg" alt="Discord"></a>
            </div>
        </section>
        """,
        unsafe_allow_html=True
